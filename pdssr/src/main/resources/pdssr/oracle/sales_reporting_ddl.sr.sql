...
;--
create sequence distributor_customer_id_seq
;--
create sequence etl_customer_id_seq
;--
create sequence etl_customer_tot_id_seq
;--
create sequence etl_file_id_seq
;--
create sequence etl_inventory_id_seq
;--
create sequence etl_inventory_tot_id_seq
;--
create sequence etl_sale_id_seq
;--
create sequence etl_sale_tot_id_seq
;--
create sequence org_id_seq
;--
create sequence org_customer_id_seq
;--
create sequence org_datafeed_id_seq
;--
create sequence org_distrib_id_seq
;--
create sequence org_mfr_id_seq
;--
create sequence post_sale_id_seq
;--
create sequence product_id_seq
;--
create sequence product_nomen_id_seq
;--
create sequence product_pkg_id_seq
;--
create sequence product_suspect_dtl_id_seq
;--
...
;--
create table org (
    org_id number(9) primary key not null,
    org_cd varchar(16),
    org_nm varchar(32)
)
;--
create table org_datafeed (
    org_id number(9) primary key not null references org(org_id)
)
;--
...
create table distributor_customer (
    distributor_customer_id number(9) not null primary key,
...
create table customer_info (
    customer_info_id     number(9) primary key not null,
...
create table etl_customer_tot (
    etl_file_id        number(9) primary key references etl_file,
    line_number         integer not null,
    customer_count     numeric(9) not null
)
;--
create table etl_inventory (
    etl_inventory_id        number(9) primary key,
    etl_file_id             integer  not null references etl_file,
    line_number             integer,
...
create table etl_sale (
    etl_sale_id         number(9) primary key,
    etl_file_id         integer not null references etl_file,
    line_number         integer,
    distrib_Id          varchar(10) not null,
...
create table product_pkg (
    product_pkg_id      number(9) primary key,
...
create table product_nomen (
    product_nomen_id   number(9)  primary key,
...
create table customer (
    customer_id  number(9) primary key references org(org_id)
)
;--
create table product_suspect_hdr (
    product_suspect_hdr_id number(9) not null primary key,
    descr                  varchar(60)
)
;--
create table product_suspect_dtl (
    product_suspect_dtl_id number(9) primary key not null,
...
create table post_sale (
    etl_sale_id     number(9) primary key references etl_sale(etl_sale_id),
    org_distrib_id  integer references org_distrib(org_id),
...
create table validated_address (
    validated_address_id number(9) primary key,
    addr_1              varchar(30),
    addr_2              varchar(30),
    city                varchar(25),
    state               varchar(2),
...
select
        ...
        cond.table_name,
        cond.condition_name,
        count(crow.ut_condition_run_step_id) condition_count
from    ut_condition_row_msg crow,
        ut_condition_run_step step,
        ut_condition_run run,
        ut_condition cond,
        ut_condition_run_parm p
where 	crow.ut_condition_run_step_id  = step.ut_condition_run_step_id and
