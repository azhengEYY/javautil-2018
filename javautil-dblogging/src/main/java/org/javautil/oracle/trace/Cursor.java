...
/// LoggerFactory.getLogger(Cursor.class.getName());
...
// * Depth, Cursor Key,
// */
// private final TreeMap<String, Cursor> childrenByKey = new TreeMap<String,
/// Cursor>();
...
// */
// private final HashMap<String, Object> waitAggregations = new HashMap<String,
/// Object>();
//
...
// }
//
// if (parsing == null && !rec.getRecordType().equals(RecordType.PARSING) &&
/// rec.getCursorNumber() != 0) {
// logger.warn("parsing record not found for this cursor found at line # " +
/// rec.getLineNumber());
// }
...
// }
//
//// public void add(final Close event) {
//// if (execs == null) {
//// execs = new ArrayList<Close>();
//// }
//// execs.add(event);
//// }
////
...
// return parsing == null ? null : parsing.getSgaAddress();
// }
//
...
//// * @return the execs
//// */
//// public ArrayList<Close> getExecs() {
//// return execs;
//// }
//
// /**
...
// }
//
// public CursorOperationAggregation getFetchAggregation(final boolean
/// createIfNull) {
...
// return parsing == null ? -1 : parsing.getSqlTextHashValue();
// }
//
...
// * the execAggregation to set
// */
// public void setExecAggregation(final CursorOperationAggregation
/// execAggregation) {
...
//// * the execs to set
//// */
//// public void setExecs(final ArrayList<Close> execs) {
//// this.execs = execs;
//// }
//
// /**
...
// */
// public void setFetchAggregation(final CursorOperationAggregation
/// fetchAggregation) {
...
// */
// public void setParseAggregation(final CursorOperationAggregation
/// parseAggregation) {
...
// throw new IllegalStateException("may only call this once per cursor invoke
/// from line number "
// + parsing.getLineNumber() + " was declared from " +
/// this.parsing.getLineNumber());
// }
...
// break;
// default:
// logger.info("uncategorized event on line " + rec.getLineNumber() + " " +
/// rec);
// }
// }
//
...
// }
//
// private void appendAggregation(final StringBuilder b, final
/// CursorOperationAggregation o) {
// if (o != null) {
// b.append(o.toString());
// b.append("\n");
// }
