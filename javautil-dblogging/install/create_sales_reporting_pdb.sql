...
CREATE PLUGGABLE DATABASE sales_reporting_pdb ADMIN USER sr IDENTIFIED BY tutorial
  STORAGE (MAXSIZE 2G)
  DEFAULT TABLESPACE sales_reporting
    DATAFILE '/common/oracle/oradata/DEV18B/sales_reporting_pdb/sales_reporting.dbf' 
